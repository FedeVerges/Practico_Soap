...
public interface CreditCardValidatorSoap {
    ...
    @RequestWrapper(localName = "GetCardType", targetNamespace = "http://localhost/SmartPayments/", className = "com.unsl.practico.soa.ejercicio7.generated.tarjetas.GetCardType")
    @ResponseWrapper(localName = "GetCardTypeResponse", targetNamespace = "http://localhost/SmartPayments/", className = "com.unsl.practico.soa.ejercicio7.generated.tarjetas.GetCardTypeResponse")
    ...
    @RequestWrapper(localName = "IsCommercialCard", targetNamespace = "http://localhost/SmartPayments/", className = "com.unsl.practico.soa.ejercicio7.generated.tarjetas.IsCommercialCard")
    @ResponseWrapper(localName = "IsCommercialCardResponse", targetNamespace = "http://localhost/SmartPayments/", className = "com.unsl.practico.soa.ejercicio7.generated.tarjetas.IsCommercialCardResponse")
    ...
    @RequestWrapper(localName = "ValidCard", targetNamespace = "http://localhost/SmartPayments/", className = "com.unsl.practico.soa.ejercicio7.generated.tarjetas.ValidCard")
    @ResponseWrapper(localName = "ValidCardResponse", targetNamespace = "http://localhost/SmartPayments/", className = "com.unsl.practico.soa.ejercicio7.generated.tarjetas.ValidCardResponse")
    ...
    @RequestWrapper(localName = "ValidCardLength", targetNamespace = "http://localhost/SmartPayments/", className = "com.unsl.practico.soa.ejercicio7.generated.tarjetas.ValidCardLength")
    @ResponseWrapper(localName = "ValidCardLengthResponse", targetNamespace = "http://localhost/SmartPayments/", className = "com.unsl.practico.soa.ejercicio7.generated.tarjetas.ValidCardLengthResponse")
    ...
    @RequestWrapper(localName = "ValidExpDate", targetNamespace = "http://localhost/SmartPayments/", className = "com.unsl.practico.soa.ejercicio7.generated.tarjetas.ValidExpDate")
    @ResponseWrapper(localName = "ValidExpDateResponse", targetNamespace = "http://localhost/SmartPayments/", className = "com.unsl.practico.soa.ejercicio7.generated.tarjetas.ValidExpDateResponse")
    ...
    @RequestWrapper(localName = "ValidMod10", targetNamespace = "http://localhost/SmartPayments/", className = "com.unsl.practico.soa.ejercicio7.generated.tarjetas.ValidMod10")
    @ResponseWrapper(localName = "ValidMod10Response", targetNamespace = "http://localhost/SmartPayments/", className = "com.unsl.practico.soa.ejercicio7.generated.tarjetas.ValidMod10Response")
    ...
    @RequestWrapper(localName = "GetNetworkID", targetNamespace = "http://localhost/SmartPayments/", className = "com.unsl.practico.soa.ejercicio7.generated.tarjetas.GetNetworkID")
    @ResponseWrapper(localName = "GetNetworkIDResponse", targetNamespace = "http://localhost/SmartPayments/", className = "com.unsl.practico.soa.ejercicio7.generated.tarjetas.GetNetworkIDResponse")
    ...
    @RequestWrapper(localName = "IsFSACard", targetNamespace = "http://localhost/SmartPayments/", className = "com.unsl.practico.soa.ejercicio7.generated.tarjetas.IsFSACard")
    @ResponseWrapper(localName = "IsFSACardResponse", targetNamespace = "http://localhost/SmartPayments/", className = "com.unsl.practico.soa.ejercicio7.generated.tarjetas.IsFSACardResponse")
    ...
    @RequestWrapper(localName = "IsValidCheckRoutingNumber", targetNamespace = "http://localhost/SmartPayments/", className = "com.unsl.practico.soa.ejercicio7.generated.tarjetas.IsValidCheckRoutingNumber")
    @ResponseWrapper(localName = "IsValidCheckRoutingNumberResponse", targetNamespace = "http://localhost/SmartPayments/", className = "com.unsl.practico.soa.ejercicio7.generated.tarjetas.IsValidCheckRoutingNumberResponse")
     ...
     * @param cardNumber
     * @return
     *     returns com.unsl.practico.soa.ejercicio7.generated.tarjetas.IsDebitCardResponse.IsDebitCardResult
     */
    ...
    @RequestWrapper(localName = "IsDebitCard", targetNamespace = "http://localhost/SmartPayments/", className = "com.unsl.practico.soa.ejercicio7.generated.tarjetas.IsDebitCard")
    @ResponseWrapper(localName = "IsDebitCardResponse", targetNamespace = "http://localhost/SmartPayments/", className = "com.unsl.practico.soa.ejercicio7.generated.tarjetas.IsDebitCardResponse")
    public com.unsl.practico.soa.ejercicio7.generated.tarjetas.IsDebitCardResponse.IsDebitCardResult isDebitCard(
        @WebParam(name = "CardNumber", targetNamespace = "http://localhost/SmartPayments/")
        String cardNumber);
