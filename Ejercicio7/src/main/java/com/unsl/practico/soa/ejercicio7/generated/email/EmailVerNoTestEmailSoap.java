...
public interface EmailVerNoTestEmailSoap {
    ...
    @RequestWrapper(localName = "VerifyMXRecord", targetNamespace = "http://ws.cdyne.com/", className = "com.unsl.practico.soa.ejercicio7.generated.email.VerifyMXRecord")
    @ResponseWrapper(localName = "VerifyMXRecordResponse", targetNamespace = "http://ws.cdyne.com/", className = "com.unsl.practico.soa.ejercicio7.generated.email.VerifyMXRecordResponse")
    ...
    @RequestWrapper(localName = "AdvancedVerifyEmail", targetNamespace = "http://ws.cdyne.com/", className = "com.unsl.practico.soa.ejercicio7.generated.email.AdvancedVerifyEmail")
    @ResponseWrapper(localName = "AdvancedVerifyEmailResponse", targetNamespace = "http://ws.cdyne.com/", className = "com.unsl.practico.soa.ejercicio7.generated.email.AdvancedVerifyEmailResponse")
    ...
    @RequestWrapper(localName = "VerifyEmail", targetNamespace = "http://ws.cdyne.com/", className = "com.unsl.practico.soa.ejercicio7.generated.email.VerifyEmail")
    @ResponseWrapper(localName = "VerifyEmailResponse", targetNamespace = "http://ws.cdyne.com/", className = "com.unsl.practico.soa.ejercicio7.generated.email.VerifyEmailResponse")
    ...
    @RequestWrapper(localName = "ReturnCodes", targetNamespace = "http://ws.cdyne.com/", className = "com.unsl.practico.soa.ejercicio7.generated.email.ReturnCodes")
    @ResponseWrapper(localName = "ReturnCodesResponse", targetNamespace = "http://ws.cdyne.com/", className = "com.unsl.practico.soa.ejercicio7.generated.email.ReturnCodesResponse")
